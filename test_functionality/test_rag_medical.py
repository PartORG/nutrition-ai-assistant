"""
Test Medical RAG retrieval

Instructions:
- This script tests the MedicalRAG system for extracting dietary constraints.
- Dummy user is ensured in DB.
- You can modify the 'conditions' list to test different medical conditions (e.g. ["ALS", "diabetes"]).
- Prints NutritionConstraints result for the specified conditions.
...
async def main():
    ...
    rag = factory._medical_rag
    conditions = ["ALS"]  # Modify this list to test other conditions
    results = await rag.get_constraints(conditions)
    print("Medical RAG Results:", results)
